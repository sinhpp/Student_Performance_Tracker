      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="flex items-center space-x-6 mb-6">
          <div class="relative">
            ...
            <div v-else class="h-20 w-20 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full flex items-center justify-center">
              <span class="text-white font-bold text-2xl">{{ profileStore.fullName?.charAt(0) || 'T' }}</span>
            </div>
          ...
          <div>
            ...
            <span class="inline-flex px-2 py-1 text-xs font-semibold text-blue-800 bg-blue-100 rounded-full mt-1">
            ...
            <div>
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-900">{{ profile?.employee_id }}</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="space-y-4">
                <div>
                  ...
                  />
                  <p v-else class="mt-1 text-sm text-gray-900">{{ profile?.department || 'Not specified' }}</p>
                </div>
                <div>
                  ...
                  />
                  <p v-else class="mt-1 text-sm text-gray-900">{{ profile?.specialization || 'Not specified' }}</p>
                </div>
                <div>
                  ...
                  <input
                    ...
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  />
                  <p v-else class="mt-1 text-sm text-gray-900">{{ profile?.hire_date || 'Not provided' }}</p>
                </div>
                <div>
